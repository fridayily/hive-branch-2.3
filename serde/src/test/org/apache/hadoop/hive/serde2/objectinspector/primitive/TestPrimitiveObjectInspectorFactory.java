...
public class TestPrimitiveObjectInspectorFactory extends TestCase {
    ...
    public void testGetPrimitiveWritableObjectInspector() {
        ...
        WritableHiveVarcharObjectInspector writableHiveVarcharObjectInspector = PrimitiveObjectInspectorFactory.writableHiveVarcharObjectInspector;
        // PrimitiveObjectInspectorFactory 中先 实例化了 writableHiveVarcharObjectInspector，然后将 writableHiveVarcharObjectInspector 放到一个 EnumMap 中
    ...
    public void testGetPrimitiveJavaObjectInspector() {
        // even without type params, return a default OI for varchar
        PrimitiveObjectInspector poi = PrimitiveObjectInspectorFactory.getPrimitiveJavaObjectInspector(PrimitiveCategory.VARCHAR);
        assertEquals(poi, PrimitiveObjectInspectorFactory.javaHiveVarcharObjectInspector);

        // same for char
        poi = PrimitiveObjectInspectorFactory.getPrimitiveJavaObjectInspector(PrimitiveCategory.CHAR);
